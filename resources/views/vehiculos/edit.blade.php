...
<form action="{{ route('vehiculos.update', $vehiculo) }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="placa" class="form-control" values="{{ $vehiculo->placa }}" required>
    </div>
    ...
    <div class="mb-3">
        ...
        <textarea name="observaciones" class="form-control" rows="3">{{ $vehiculo->observacion }}</textarea>
    </div>
